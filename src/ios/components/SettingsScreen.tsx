...
export function SettingsScreen({ onClose }: Props) {
  ...
  return (
    <div className="safe-screen fixed inset-0 bg-gray-50 z-[100] flex flex-col font-sans select-none" dir="rtl">
      <div className="bg-white border-b-2 border-gray-100 p-4 flex justify-between items-center shrink-0 shadow-sm">
        ...
        <button aria-label="סגירת הגדרות" onClick={onClose} className="w-11 h-11 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center font-bold text-xl hover:bg-gray-200 transition-colors">✕</button>
      </div>
